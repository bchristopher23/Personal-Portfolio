(function () {
    ...
    function loadModel() {
        ...
        // Load the model
        gltfLoader.load('/portfolio/cube/models/model.gltf', function(gltf) {
            
            model = gltf.scene; 
            liquid = model.children[1];
            liquidEnvMap = new THREE.CubeTextureLoader()
            .setPath( '/portfolio/cube/models/liquidMap/' )
            ...
            let cube = model.children[0],
                ...
                wood = textureLoader.load('/portfolio/cube/models/textures/wood.png'),
                woodAo = textureLoader.load('/portfolio/cube/models/textures/wood_ao.png'),
                woodNormal = textureLoader.load('/portfolio/cube/models/textures/wood_normal.png'),
                woodRough = textureLoader.load('/portfolio/cube/models/textures/wood_rough.png'),
                woodBump = textureLoader.load('/portfolio/cube/models/textures/wood_bump.png'),
